...
Route::middleware(['admin'])->group(function() {
    ...
    Route::delete('/orders/{order}', [OrderController::class, 'destroy'])->name('delete_order');
    Route::get('/orders', [OrderController::class, 'index'])->name('orders.index');
    Route::get('/order', [OrderController::class, 'index_order'])->name('index_order');
    Route::get('/paidorder', [OrderController::class, 'paidOrders'])->name('paidOrder');
...
Route::middleware(['auth'])->group(function() {
    ...
    Route::put('confirm/{confirm}', [ConfirmController::class, 'arrive'])->name('confirm.arrive');
